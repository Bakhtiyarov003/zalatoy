...
ob_start();
define("uzfox","1148801029:AAGxKaP4HuXdw2Amdv1PaGuDWKAowonaT5M");
$admin = "1139073652";
$botname = "MegaPayuzBot";
...
"photo"=>"https://t.me/baaabtu/4",
    "caption"=>"✅ <b>MegaPay tizimining rasmiy boti</b> 🤖\n\n🎈 $username do'stingizdan unikal havola-taklifnoma.\n\n👇 Boshlash uchun bosing:
...
if((stripos($callbackdata,"send|")!==false) and ($from_id=="1139073652")){
    uzfox("deleteMessage",[
    "chat_id"=>$chat_id,
    "message_id"=>$message_id,
]); 
...
"parse_mode"=>"markdown",
       ...
       uzfox("sendMessage",[
              ...
              "parse_mode"=>"html",
               "reply_markup"=>json_encode([   
   "inline_keyboard"=>[
[["text"=>"👨‍💻 Admin","url"=>"https://telegram.me/MegaPayadminbot"],["text"=>"👥 Kanalimiz","url"=>"https://t.me/Boom_Pay"],],
]
]),
]);
}

if((stripos($callbackdata,"no|")!==false) and ($from_id=="1139073652")){
        uzfox("deleteMessage",[
    "chat_id"=>$chat_id,
    "message_id"=>$message_id,
]); 
...
if((stripos($callbackdata,"ban|")!==false) and ($from_id=="1139073652")){
        uzfox("deleteMessage",[
    "chat_id"=>$chat_id,
    "message_id"=>$message_id,
]); 
...
"disable_web_page_preview"=>true,
"parse_mode"=>"html",
"message_text"=>"✅ <b>MegaPay tizimining rasmiy boti</b> 🤖\n\n🎈 $username do'stingizdan unikal havola-taklifnoma.\n\n👇 Boshlash uchun bosing:
...
uzfox("sendPhoto",[
"chat_id"=>$chatid,
"photo"=>"https://t.me/baaabtu/5",
"caption"=>"<b>Sizga shunday botlar kerak bo'lsa dasturchiga yozing.</b>\n\n<b>Ish vaqti: 07:00 dan 23:00 gacha</b>\n\n<b>Diqqat! Bot pul to'lab berish yoki to'lab bermasligiga dasturchi javobgar emas!</b>",
"parse_mode"=>"html",
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"♻️ Bogʻlanish","url"=>"https://t.me/fhf_admin"],],
]
]),
]);
}
